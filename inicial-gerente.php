...
<html lang="pt-br">
  ...
  <body>
    ...
    <!-- <i class="fa-solid fa-car fa-2x" style="color: #1f4f9c;"></i> -->
    <!-- <i class="fa-solid fa-file-contract fa-2x" style="color: #1f4f9c;"></i> -->
    <!-- <i class="fa-solid fa-chart-simple fa-2x" style="color: #204f9c;"></i> -->
    <!-- <i class="fa-solid fa-people-group fa-2x" style="color: #1f4f9c;"></i> -->
